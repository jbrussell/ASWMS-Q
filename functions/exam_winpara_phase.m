function outevent = exam_winpara_phase(event)

setup_parameters;

load ./functions/phasedb.mat
cheatsheetphases = {'P','PP','S',...
    'SS','SSS','SSSS',...
    };
...
while 1
    ...
    if is_cheatsheet
        for ip = 1:length(eventphases)
            ...
            text(textx,texty,eventphases(ip).name,'color','b','fontsize',20,'linewidth',2);
