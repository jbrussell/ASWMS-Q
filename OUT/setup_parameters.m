...
if ~exist(parameters.workingdir ,'dir')
...
parameters.proj_name = 'YS';
parameters.component = 'BHZ';   % determined by filenames
parameters.lalim=[14 27];
parameters.lolim=[-163 -149];
...
parameters.start_time = '2005-01-01 00:00:00';
parameters.end_time = '2008-01-01 00:00:00'; % put '' for using 4 days before current date
parameters.is_use_timestamp = 0;
parameters.network = '_HAWAII';
parameters.minMw = 6;
