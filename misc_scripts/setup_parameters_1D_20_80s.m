...
parameters.periods = [20, 23, 27, 31, 36, 41, 47, 55, 63, 73, 84];
...
parameters.smweight_array = 10*[0.4 0.3 0.2 0.2 0.2 0.5 0.5 0.5 1 1 1];  % 2nd derivative smoothing weight for the deltaSx and delta Sy
parameters.flweight_array = 100*ones(size(parameters.periods)); % JBR - 1st derivative smoothing
