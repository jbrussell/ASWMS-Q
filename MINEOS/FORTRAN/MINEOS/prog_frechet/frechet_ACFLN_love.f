...
c	  JOSH
c 	  08/03/17 - Modified to calculate ACFLN Kernels. Same as frechet_ACFLN.f but 
c                doesn't multiply each kernel by rho*V**2
c
