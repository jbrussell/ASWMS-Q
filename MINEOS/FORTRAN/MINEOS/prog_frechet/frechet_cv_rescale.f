...
C23456789112345678921234567893123456789412345678951234567896123456789712
c
c       JBR, 8/17/17 to fix dc/dm scale
c		   OLD:    dcv1=((cv1**2.)/(gv1))*buf(kk)
c                  dcv2=((cv2**2.)/(gv2))*buf2(kk)
c
c		   NEW:    dcv1=((cv1)/(gv1))*buf(kk)
c                  dcv2=((cv2)/(gv2))*buf2(kk)
c
C23456789112345678921234567893123456789412345678951234567896123456789712
c
...
c              OLD SCALING
c              dcv1=((cv1**2.)/(gv1))*buf(kk)
c              dcv2=((cv2**2.)/(gv2))*buf2(kk)

c             JOSH FIX SCALE
              dcv1=((cv1)/(gv1))*buf(kk)
              dcv2=((cv2)/(gv2))*buf2(kk)
c for G kernels
c              dcv1 = buf(kk)
c              dcv2 = buf2(kk) 
              dcv3=(dcv1+dcv2)/2.
