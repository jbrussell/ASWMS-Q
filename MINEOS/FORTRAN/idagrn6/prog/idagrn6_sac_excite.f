      program idagrn6_sac_excite
c Modified by jbr (07/10/18) to also output excitation terms.
c
...
c         close(12)
         ...
         call setfhv('DIST',real(del(ista)),nerr)
         call setfhv('AZ',real(azm(ista)),nerr)
