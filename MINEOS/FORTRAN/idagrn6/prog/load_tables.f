...
C      print*,'source_file1 = ',source_file
C      print*,'kblnk1 = ',k
      

      open(io,form='unformatted',file=source_file(1:k)//'_hdr',
C      open(io,form='unformatted',file=source_file(1:k)//'to200.table_hdr',
     &     access = 'sequential')
...
C      print*,'source_file before: ', source_file
      source_file = adjustl(source_file)
C      print*,'source_file after: ', source_file
      call kblnk(source_file,k)
C      print*,'kblnk2 = ',k
